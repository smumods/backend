...
RSpec.describe ClubsController, type: :controller do
  ...
  describe "GET #show" do
    it "returns a success response" do
      ...
      get :show, params: {id: club.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Club" do
        expect {
          post :create, params: {club: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, params: {club: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested club" do
        club = Club.create! valid_attributes
        put :update, params: {id: club.to_param, club: new_attributes}, session: valid_session
        club.reload
      ...
      it "redirects to the club" do
        club = Club.create! valid_attributes
        put :update, params: {id: club.to_param, club: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        club = Club.create! valid_attributes
        put :update, params: {id: club.to_param, club: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested club" do
      club = Club.create! valid_attributes
      expect {
        delete :destroy, params: {id: club.to_param}, session: valid_session
      }.to change(Club, :count).by(-1)
    end
